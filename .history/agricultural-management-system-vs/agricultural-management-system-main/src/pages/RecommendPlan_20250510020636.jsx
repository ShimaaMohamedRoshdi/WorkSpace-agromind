...
const RecommendPlan = () => {
  ...
  return (
    <div className="recommend-crop-container" style={{ maxWidth: '600px', margin: '2rem auto', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>Recommend Plan</h2>
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="startDate" style={{ display: 'block', marginBottom: '0.5rem' }}>Crop Planting Start Date:</label>
          <input
            type="date"
            id="startDate"
            value={startDate}
        ...
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="endDate" style={{ display: 'block', marginBottom: '0.5rem' }}> Crop Planting End Date:</label>
          <input
            type="date"
            id="endDate"
            value={endDate}
