  ...
  useEffect(() => {
    const fetchCrops = async () => {
      try {
        ...
        // Map data to include startDate, endDate, duration
        const mapped = data.map((crop) => {
          const startDate = crop.startDate || crop.StartDate || null;
          ...
          return {
            ...
            price: crop.price || crop.TotalCost || 0,
            category: crop.category || crop.CropType || "Uncategorized",
            id: crop.id || crop.Id,
