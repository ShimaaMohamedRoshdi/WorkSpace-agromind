  ...
  return (
    <div>
      ...
      <div className="container py-5 ">
        ...
        {/* Categories Filter */}
        <div className="mb-3 border rounded p-3 shadow-sm" style={{ maxHeight: "200px", overflowY: "auto" }}>
            ...
            <div className="mt-3">
              ...
              <ul className="list-group list-group-flush">
                {selectedCategories.map((cat) => (
                  <li key={`selected-${cat}`} className="list-group-item text-capitalize py-1">
                    {cat}
                  </li>
                ))}
              </ul>
