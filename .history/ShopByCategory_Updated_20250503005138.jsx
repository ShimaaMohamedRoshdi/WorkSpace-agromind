...
//                   />
//                   <label className="form-check-label" htmlFor={`cat-${cat}-${index}`}>
//                     {cat}
//                   </label>
//                 </div>
//               ))}
...
const ShopByCategory = () => {
  ...
  // Combine and clean all product arrays
  const allProducts = [
    ...products,
    ...products2,
    ...products3,
  ...
  return (
    <div className="container py-5">
      <h2 className="text-center mb-4 fw-bold">Shop By Category</h2>
      <div className="row">
        {/* Left panel: Sort and categories */}
        <div className="col-md-3 mb-4">
          <div className="mb-3">
            <label htmlFor="sort" className="form-label fw-semibold">
              Sort by:
          ...
          >
            ...
            {selectedCategories.length > 0 && (
              <div className="mt-3">
                <h6 className="fw-semibold">Selected Categories:</h6>
