...
const categories = [
  ...
  { title: "Fertilizers", image: cat1, path: "/category/fertilizers" },
  { title: "Fungicides", solid: true, path: "/category/fungicides" },
];
        ...
        <div className="col-lg-7">
          <div className="d-flex flex-column gap-3">
            ...
            <div className="d-flex gap-3">
              <div
                className="cat-box half"
                onClick={() => handleClick(categories[4].path)}
                style={{ backgroundImage: `url(${categories[4].image})` }}
              >
                <span>Fertilizers</span>
              </div>
              <div
                className="cat-box half solid"
                onClick={() => handleClick(categories[5].path)}
              >
